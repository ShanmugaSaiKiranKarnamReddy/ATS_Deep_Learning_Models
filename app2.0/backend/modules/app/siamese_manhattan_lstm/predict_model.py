...
EMBEDDING_FILE = './data/Resume_JD_new_14.w2v'
#word2vec embedding
...
def predict_model(pairs):
    ...
    model = tf.keras.models.load_model(os.path.join(__location__, 'SiameseLSTM_new20.h5'), custom_objects={'ManDist': ManDist})
    model.summary()
