...
df_dev = pd.read_csv("C://Users//Vicky//source//universityWork//case-study-1-october2019-case-study-group-2//app//backend//RNN//test2.txt", sep = '\t', encoding = "ISO-8859-1")
df_train = pd.read_csv("C://Users//Vicky//source//universityWork//case-study-1-october2019-case-study-group-2//app//backend//RNN//train1.txt",sep ='\t', encoding = "ISO-8859-1")
...
df_dev = pd.read_csv("C://Users//Vicky//source//universityWork//case-study-1-october2019-case-study-group-2//app//backend//RNN//test4.csv",sep ='$', encoding = "ISO-8859-1")
dataset_dev = ats(df_dev, vocabulary_size, dictionary_train)
dev_loader = DataLoader(dataset=dataset_dev,
                         batch_size=1, shuffle=False, collate_fn=pad_collate)
