...
df_train = pd.read_csv("train1.txt",sep ='\t', encoding = "ISO-8859-1")
df_dev = pd.read_csv("MLSTM_TEST_2.csv",sep ='$', encoding = "ISO-8859-1")
...
checkpoint = torch.load('checkpoint.pth.3.acc.8.7.tar')
